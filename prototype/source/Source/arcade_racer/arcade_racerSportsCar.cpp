...
#include "arcade_racerSportsCar.h"
#include "arcade_racerSportsWheelFront.h"
#include "arcade_racerSportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

Aarcade_racerSportsCar::Aarcade_racerSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = Uarcade_racerSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = Uarcade_racerSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = Uarcade_racerSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = Uarcade_racerSportsWheelRear::StaticClass();
