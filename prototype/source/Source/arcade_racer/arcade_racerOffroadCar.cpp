...
#include "arcade_racerOffroadCar.h"
#include "arcade_racerOffroadWheelFront.h"
#include "arcade_racerOffroadWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"
#include "GameFramework/SpringArmComponent.h"

Aarcade_racerOffroadCar::Aarcade_racerOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = Uarcade_racerOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = Uarcade_racerOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = Uarcade_racerOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = Uarcade_racerOffroadWheelRear::StaticClass();
